...
/* ------------------------------------------------------------------
   Fix walkable_floqs function return type to match TypeScript schema
   - Drop existing function first
   - Recreate with correct column names: distance_meters, participant_count
------------------------------------------------------------------- */

-- Drop the existing function first
DROP FUNCTION IF EXISTS public.walkable_floqs(double precision, double precision, integer);
