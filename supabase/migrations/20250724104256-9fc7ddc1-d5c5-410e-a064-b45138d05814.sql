-- Complete the missing database pieces for location pipeline

-- 1. Ensure venues table is complete (already done but let's verify)
-- 2. Update build_daily_afterglow to handle the nightly sweep properly
