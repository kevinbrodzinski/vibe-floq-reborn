-- ============================================================
--  FLOQ • CORE BACK-END SCHEMA (v0.9 – TestFlight) - Fixed
-- ============================================================
...
drop policy if exists "can read permitted vibes" on public.user_vibe_states;
drop policy if exists "owner can upsert vibe" on public.user_vibe_states;
...
-- Add missing policies for floq_participants (drop first to avoid conflicts)
drop policy if exists "member can read own floq membership" on public.floq_participants;
drop policy if exists "anyone can join public floq" on public.floq_participants;
