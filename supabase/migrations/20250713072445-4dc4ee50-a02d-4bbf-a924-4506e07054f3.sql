-- Progressive Vibe Auto-Update Schema Migration (Fixed Indexes)
...
-- Create performance indexes (without immutable function constraints)
CREATE INDEX IF NOT EXISTS idx_profiles_interests_gin 
ON public.profiles USING gin(interests);

CREATE INDEX IF NOT EXISTS idx_floqs_tags_gin 
...
CREATE INDEX IF NOT EXISTS idx_floqs_activity_composite 
ON public.floqs (activity_score DESC, ends_at DESC, visibility);

CREATE INDEX IF NOT EXISTS idx_flock_relationships_strength 
