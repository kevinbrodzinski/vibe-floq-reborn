-- Add sample user_vibe_states entries with correct vibe enum values
...
('55555555-5555-5555-5555-555555555555', 'flowing', ST_SetSRID(ST_MakePoint(-118.2437, 34.0522), 4326), now() - interval '12 minutes', true),
...
('88888888-8888-8888-8888-888888888888', 'open', ST_SetSRID(ST_MakePoint(-118.2637, 34.0322), 4326), now() - interval '3 minutes', true)
