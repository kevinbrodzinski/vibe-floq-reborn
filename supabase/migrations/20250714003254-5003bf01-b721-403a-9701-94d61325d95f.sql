-- Enhanced FloqCard implementation - Phase 1: Database Schema (Updated with DROP FUNCTION)
...
-- 1-e: Drop existing function before recreating with new signature
DROP FUNCTION IF EXISTS public.get_active_floqs_with_members(integer, integer, double precision, double precision, flock_type_enum);

-- 1-f: Create updated get_active_floqs_with_members function
