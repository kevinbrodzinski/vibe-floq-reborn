-- Fix RPC function by dropping and recreating
BEGIN;

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS public.record_preference_signal(jsonb, timestamptz);
...
-- Create the RPC function with correct signature
