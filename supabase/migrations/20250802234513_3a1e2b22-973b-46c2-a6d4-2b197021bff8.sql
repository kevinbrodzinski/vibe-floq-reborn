-- Fix venue schema without touching generated columns
-- Migration: 20250802_fix_venue_schema_safe
...
-- Step 7: Update RPC functions to use new fields and existing geom column
...
-- Step 9: Update table statistics for query planning
