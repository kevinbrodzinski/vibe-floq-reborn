-- Enhanced demo direct messaging schema with optimizations (fixed syntax)

-- 1. Create demo.direct_threads with proper constraints
...
CREATE UNIQUE INDEX demo_threads_unique_pair_idx 
  ON demo.direct_threads (LEAST(member_a, member_b), GREATEST(member_a, member_b));

-- 2. Create demo.direct_messages with proper constraints
