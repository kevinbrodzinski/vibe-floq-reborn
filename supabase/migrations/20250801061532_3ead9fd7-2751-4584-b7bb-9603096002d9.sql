/* ===================================================================
   20250804__restore_get_nearby_venues.sql
   • Drop broken overload (geom-based)
   • Recreate correct location-based function
=================================================================== */
BEGIN;
...
-- 2️⃣  Recreate the canonical version
...
AS $function$
  WITH me AS (
    ...
    SELECT
      ...
      ST_Distance(v.location, me.g)       AS distance_m,
      v.live_count  AS people_now
