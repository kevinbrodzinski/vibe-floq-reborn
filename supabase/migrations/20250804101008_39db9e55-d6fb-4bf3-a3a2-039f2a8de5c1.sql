...
--──────────────────────────────
-- 1 ▸ Drop old triggers & functions (comprehensive)
--──────────────────────────────
...
DROP FUNCTION IF EXISTS public.notify_dm() CASCADE;
DROP FUNCTION IF EXISTS public.notify_plan_invite() CASCADE;
DROP FUNCTION IF EXISTS public.notify_floq_invite() CASCADE;
DROP FUNCTION IF EXISTS public.fn_notify_friend_request() CASCADE;
DROP FUNCTION IF EXISTS public.fn_notify_floq_invite() CASCADE;
DROP FUNCTION IF EXISTS public.fn_notify_plan_invite() CASCADE;
