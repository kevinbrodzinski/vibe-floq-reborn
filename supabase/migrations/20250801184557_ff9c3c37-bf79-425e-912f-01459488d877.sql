...
DROP FUNCTION IF EXISTS public.search_profiles_with_status(text, int, uuid);

-- Create the improved function with proper aliases, precedence, privacy guard and full-text search
