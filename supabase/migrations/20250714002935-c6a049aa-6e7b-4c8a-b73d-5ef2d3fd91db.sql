-- Enhanced FloqCard implementation - Phase 1: Database Schema

-- 1-a: Add description column to floqs table
...
-- 1-d: Update get_active_floqs_with_members to include description and exclude ignored floqs
