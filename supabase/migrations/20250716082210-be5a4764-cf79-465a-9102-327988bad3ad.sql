  ...
  with check (
    exists (
      select 1
       ...
       where da.id      = afterglow_share_links.daily_afterglow_id
...
create policy p_share_links_owner_update_img
  ...
  with check (
    slug               = afterglow_share_links.slug                 and
    daily_afterglow_id = afterglow_share_links.daily_afterglow_id   and
    created_at         = afterglow_share_links.created_at           and
