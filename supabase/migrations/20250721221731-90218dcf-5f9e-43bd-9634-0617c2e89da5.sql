...
-- 1. Clean up any previous helper
DROP FUNCTION IF EXISTS public.user_is_plan_participant(uuid);

-- 2. Helper: STABLE + PARALLEL SAFE for planner & index use
...
-- 4. Ensure other existing policies remain intact for plan creators
...
-- 5. Self-access policy (users can always see their own participation)
