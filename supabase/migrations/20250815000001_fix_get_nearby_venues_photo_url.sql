-- Fix get_nearby_venues function to include photo_url column
-- This ensures venue images are fetched from the database instead of all using fallbacks
...
AS $$
  WITH me AS (
    ...
    SELECT
      ...
      v.rating,
      v.price_range,
      COALESCE(v.canonical_tags, ARRAY[]::text[]) AS canonical_tags
