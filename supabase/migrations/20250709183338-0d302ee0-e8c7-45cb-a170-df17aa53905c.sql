...
-- Index for geohash buckets (removed immutable function from WHERE clause)
...
--------------------------------------------------------------------
-- 4 · Grant (corrected - SELECT only for tables)                  --
--------------------------------------------------------------------
GRANT SELECT ON public.vibes_now TO authenticated;