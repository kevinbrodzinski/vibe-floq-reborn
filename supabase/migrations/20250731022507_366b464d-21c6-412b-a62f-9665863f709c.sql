/* =====================================================================
   External Place Feeds – working version
   --------------------------------------------------------------------- */
...
-- 3. Enable RLS and create policy (with existence check)
...
-- 6. Create the normalizer function
...
-- 7. Add is_expired column to place_details if it doesn't exist
DO $$ BEGIN
  IF NOT EXISTS (
