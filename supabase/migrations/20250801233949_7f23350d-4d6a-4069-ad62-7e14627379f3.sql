-- Phase 2: Generate Test Data for Afterglow System (Corrected table structure)
  ...
  IF test_user_id IS NOT NULL THEN
    ...
    FOR i IN 0..2 LOOP
      ...
      FOR venue_id IN SELECT unnest(venue_ids[1:LEAST(array_length(venue_ids, 1), 2+i)]) LOOP
        ...
        -- Create venue visit record (using correct column names)
        ...
        -- Create corresponding venue stay record (using correct column names)
    ...
    FOR i IN 0..20 LOOP
      INSERT INTO public.raw_locations (
        profile_id, lat, lng, accuracy, recorded_at, geohash5, yyyymm, p_hash
      ) VALUES (
        test_user_id,
