-- Drop all function variants and recreate with float8 types
DROP FUNCTION IF EXISTS public.fn_compute_friction(uuid,jsonb,numeric,numeric,numeric,numeric,numeric);
DROP FUNCTION IF EXISTS public.fn_compute_friction(uuid,jsonb,numeric);
DROP FUNCTION IF EXISTS public.fn_compute_friction;
