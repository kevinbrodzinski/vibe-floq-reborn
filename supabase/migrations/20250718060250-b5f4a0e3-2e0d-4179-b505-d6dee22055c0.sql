...
begin
  if not exists (
    ...
    and tablename = 'field_tiles' 
    and policyname = 'field_tiles_read'
  ) then
    create policy field_tiles_read
...
begin
  if not exists (
    ...
    where schemaname = 'public' 
    and tablename = 'field_tiles' 
    and policyname = 'field_tiles_service_manage'
  ) then
    create policy field_tiles_service_manage
      on public.field_tiles
      for all
