-- Phase 3.1: Production-Safe Username Schema Migration (Constraint-First)
...
CREATE UNIQUE INDEX IF NOT EXISTS demo_profiles_username_citext_unique ON demo.profiles (username);
CREATE UNIQUE INDEX IF NOT EXISTS demo_reserved_usernames_citext_unique ON demo.reserved_usernames (name);
