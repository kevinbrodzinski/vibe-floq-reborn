-- ═══════════════════════════════════════════════════════════════════════════════
-- Visit Merging and Crossed Paths Detection (Final)
...
CREATE TABLE IF NOT EXISTS public.crossed_paths (
  ...
  UNIQUE (user_a, user_b, venue_id, encounter_date)
);

-- Create index for efficient queries
CREATE INDEX IF NOT EXISTS idx_crossed_paths_encounter_date ON public.crossed_paths(encounter_date);
