-- Fix timestamp type mismatch in add_plan_stop_with_order function
-- The function expects TIME but table columns are TIMESTAMPTZ

CREATE OR REPLACE FUNCTION public.add_plan_stop_with_order(
    p_plan_id           UUID,
    p_title             TEXT,
    p_description       TEXT DEFAULT NULL,
    p_start_time        TEXT DEFAULT NULL,  -- Changed from TIME to TEXT to handle conversion
    p_end_time          TEXT DEFAULT NULL,  -- Changed from TIME to TEXT to handle conversion
