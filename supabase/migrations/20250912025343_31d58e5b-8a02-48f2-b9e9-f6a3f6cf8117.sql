-- Complete rally inbox system with RLS and helper functions
-- Accounting for actual schema where rally_threads.rally_id is TEXT and rallies.id is UUID

-- ===================================================================
-- 1. Helper function for rally membership check
-- ===================================================================

-- Check if user is a member of a rally (handles TEXT rally_id)
...
-- ===================================================================
-- 2. Create rally_messages table if not exists
-- ===================================================================
...
-- ===================================================================
-- 3. Trigger to auto-fill rally_id
-- ===================================================================
...
-- ===================================================================
-- 5. Create rally_last_seen table if not exists
-- ===================================================================
...
-- ===================================================================
-- 6. Enable RLS and create policies for rally_threads
-- ===================================================================
...
-- Insert only if member (usually creator)
...
-- ===================================================================
-- 7. Enable RLS and create policies for rally_messages
-- ===================================================================

ALTER TABLE public.rally_messages ENABLE ROW LEVEL SECURITY;

-- Read messages if member
...
-- Insert message if member and you're the author (or system message with null author)
...
DROP POLICY IF EXISTS rally_messages_update ON public.rally_messages;
CREATE POLICY rally_messages_update
ON public.rally_messages
FOR UPDATE
USING (public.is_rally_member(rally_id) AND author_id = auth.uid())
WITH CHECK (public.is_rally_member(rally_id) AND author_id = auth.uid());

-- ===================================================================
-- 8. Enable RLS for rally_last_seen
-- ===================================================================
...
-- ===================================================================
-- 9. RPC function to mark thread as seen
-- ===================================================================
...
-- ===================================================================
-- 10. RPC function to seed invite messages
-- ===================================================================
...
BEGIN
  ...
  -- Insert invite messages for each rally participant
...
-- ===================================================================
-- 11. Materialized view for rally inbox with unread counts
-- ===================================================================

-- Helper function to get rally roles
...
-- ===================================================================
-- 13. RPC to refresh materialized view
-- ===================================================================
...
REVOKE ALL ON FUNCTION public.refresh_rally_inbox() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.refresh_rally_inbox() TO authenticated, service_role;
