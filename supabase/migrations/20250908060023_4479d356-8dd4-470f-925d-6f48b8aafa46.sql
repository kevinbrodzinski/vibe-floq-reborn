-- Drop and recreate function with float8 return types for proper JS handling
DROP FUNCTION IF EXISTS public.fn_compute_friction(uuid,jsonb,numeric,numeric,numeric,numeric,numeric) CASCADE;
