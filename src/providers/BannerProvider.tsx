...
export function BannerProvider({ children }: { children: ReactNode }) {
  ...
  const value = React.useMemo(() => ({
    ...
    activeBanner,
    dismissBanner,
    setActiveBanner, // State setters are already stable in React
    shouldShowBanner,
  }), [dismissedBannerIds, activeBanner, dismissBanner, shouldShowBanner]); // Remove setActiveBanner from deps
