...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            user_settings: {
                Row: {
                    ...
                    preferred_welcome_template: Database["public"]["Enums"]["welcome_template_enum"] |
                    null;
        ...
        Functions: {
            ...
            reorder_plan_stops: {
                Args: { _plan_id: string; _ordered_stop_ids: string[]; } |
        ...
        Enums: {
            ...
            afterglow_moment_type: "floq_joined" |
            "floq_left" |
            "vibe_change" |
            "location_arrived" |
            "location_left" |
            ...
            suggestion_type_enum: "merge_flocks" |
            "invite_user" |
            "recommend_venue" |
            "schedule_activity" |
            "change_vibe";
            ...
            welcome_template_enum: "casual-hangout" |
            "professional-meetup" |
            "event-based" |
            "study-group" |
            "creative-collab" |
