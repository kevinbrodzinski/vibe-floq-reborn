  ...
  public: {
    Tables: {
      ...
      floq_activity: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "floqs_card_view"
            referencedColumns: ["next_plan_id"]
          },
          {
            foreignKeyName: "floq_activity_plan_id_fkey"
            columns: ["plan_id"]
      ...
      floq_stream_reads: {
        ...
        Relationships: [
          {
            foreignKeyName: "floq_stream_reads_floq_id_fkey"
            columns: ["floq_id"]
            isOneToOne: false
            referencedRelation: "business_floq_detail_view"
            referencedColumns: ["id"]
      ...
      floq_wings_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "floq_stream_events_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "leaderboard_cache"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "floq_stream_events_floq_id_fkey"
            columns: ["floq_id"]
            isOneToOne: false
            referencedRelation: "business_floq_detail_view"
            referencedColumns: ["id"]
      ...
      floq_wings_votes: {
        ...
        Relationships: [
          {
            foreignKeyName: "floq_poll_votes_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "floq_wings_events"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "floq_poll_votes_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "leaderboard_cache"
            referencedColumns: ["id"]
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_from_profile_fkey"
          ...
          {
            foreignKeyName: "notifications_to_profile_fkey"
            columns: ["to_profile"]
            isOneToOne: false
            referencedRelation: "leaderboard_cache"
            referencedColumns: ["id"]
      ...
      rallies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rallies_floq_id_fkey"
            columns: ["floq_id"]
            isOneToOne: false
            referencedRelation: "business_floq_detail_view"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      search_flow_venues_enriched: {
        Args: {
          bbox_geojson?: Json
          center_lat?: number
          center_lng?: number
          include_friend_boost?: boolean
          limit_n?: number
          radius_m?: number
          since_minutes?: number
          wants_sun?: boolean
