...
import { Navigation2, Camera, Check, MapPin } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Btn>Wing</Btn><Btn>Filter</Btn><Btn glow>+ Start Rally</Btn>
        </div>
      </div>
      ...
      <Section title="Rally" icon={<Navigation2 className="h-4 w-4" />}>
        ...
        <div className="rounded-lg border border-white/10 bg-zinc-900 p-3 text-[12px]">
          ...
          <div className="mt-2 flex gap-2">
            <Btn glow>Join</Btn><Btn>Maybe</Btn><Btn>Can't</Btn>
          </div>
        </div>
      </Section>
      ...
      <div className="rounded-2xl bg-white/5 border border-white/10 p-3 flex items-center gap-2">
        ...
        <Btn>@</Btn><Btn><Camera className="h-4 w-4" /></Btn><Btn><MapPin className="h-4 w-4" /></Btn>
        <Btn glow className="!bg-gradient-to-br !from-zinc-900 !to-zinc-800">Send</Btn>
      </div>
    </div>
  );
}