...
export const PersonalMode: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      ...
      {/* Header Bar */}
      <div className="flex justify-between items-center p-3 pt-8">
        <Button
          variant="ghost"
          size="sm"
          onClick={toggleAutoMode}
          className={`p-1.5 rounded-lg bg-card/40 backdrop-blur-sm border border-border/30 transition-all duration-300 hover:bg-card/60 text-xs ${
        ...
        <h1 className="text-base font-medium text-foreground glow-primary">vibe</h1>
