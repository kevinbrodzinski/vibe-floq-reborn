    ...
    <div className={cn(
      ...
      <div className="mx-4 relative">
        <div 
          ...
          aria-label="Filters"
          tabIndex={0}
          className="overflow-x-auto overscroll-x-contain no-scrollbar snap-x scroll-smooth focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground/60"
        >
          ...
          <span className="sr-only">Scroll horizontally to see more filters</span>
        </div>
