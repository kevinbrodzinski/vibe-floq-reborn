  ...
  return (
    <>
      ...
      <div
        ...
        aria-live="polite"
      >
        <div className="px-3 py-1.5 rounded-full bg-black/80 border border-white/10 backdrop-blur-xl text-white text-xs font-medium flex items-center gap-2">
          <span>{step} / {total}</span>
          <span className="relative block w-16 h-1.5 overflow-hidden rounded">
            <span
