...
export const FieldVisualization = ({
  ...
  return (
    <div className={`relative h-full ${mini ? 'pt-2 pb-2' : 'pt-48 pb-32'} ${className}`}>
      {/* Fixed positioning overlay for geographic elements */}
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: Z_LAYERS.PEOPLE_DOTS }}>
        ...
        {!mini && venueClusters?.map((venue, index) => {
          ...
          // Convert coordinates to field percentages
          const fieldCoords = latLngToField(
          ...
          return (
            <div
              ...
              style={{
                left: `${fieldCoords.x}vw`,
                top: `${fieldCoords.y}vh`,
                transform: "translate(-50%, -50%)",
