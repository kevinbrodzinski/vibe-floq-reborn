    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      ...
      <div className="px-6 mb-8">
        <div className="flex flex-col items-center space-y-6">
          {/* New Magical Wheel Component */}
          <VibeWheel 
            size={320} 
            disabled={autoMode && isUpdating}
          />
          
          {/* Center content with vibe info */}
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-2 bg-gradient-primary bg-clip-text text-transparent">
              {safeVibe.charAt(0).toUpperCase() + safeVibe.slice(1)}
            </h2>
            ...
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-500 ${
              ...
              {isUpdating && (
                <div className="w-3 h-3 rounded-full bg-current animate-spin border-2 border-current border-t-transparent" />
              )}
              {autoMode && (
                <>
            ...
            {/* Auto-apply button for detected vibes */}
