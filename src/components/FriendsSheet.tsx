            ...
            {isLoading ? (
              ...
              <div className="space-y-2">
                {friends.slice(0, 5).map((friendId) => (
                  <div key={friendId} className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
                    <div className="relative">
                      <div className="w-10 h-10 rounded-full gradient-secondary border border-primary/30 flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      <div className="font-medium">{friendId.slice(0, 8)}...</div>
