// Minimal OKLab utilities for perceptual color mixing
// Based on Björn Ottosson's OKLab reference, trimmed for hex in/out.
// No deps. Runtime micro (we mix 2-3 colors per frame at most).
...
export function mixHexOklab(aHex:string, bHex:string, t:number): string {
