...
import { setFieldOverlayProvider, notifyFieldOverlayChanged, clearFieldOverlayProvider } from '@/lib/field/overlayBridge';
...
export function addRandomPoint() {
  ...
  try {
    ...
    console.error('❌ Failed to add random point:', error);
  }
