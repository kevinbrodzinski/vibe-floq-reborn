...
export const PHASE2 = {
  CONVERGENCE: {
    ...
    ZOOM_MIN: 12,                // LOD gate for showing signals
    K_MIN: 1,                    // k-anon
...
export const ATMO = {
  BREATH_ZOOM_MIN: 12,           // Unified LOD gate for all Phase 2 effects
  BREATHING: {
    MIN_ZOOM: 12,                // Same as BREATH_ZOOM_MIN for consistency
...
export const P3 = {
  FLOW: { MIN_ZOOM: 11, MAX_ARROWS: 500, UPDATE_HZ: 6, SMOOTH: 0.65 }, // reduced from 900/8
  LANES: { MIN_ZOOM: 12, K_MIN: 1, PROB_MIN: 0.3, ETA_MAX_MS: 300000, MAX_LANES: 32, MAX_DIST_PX: 300 }, // reduced from 64
  MOMENTUM: { MIN_ZOOM: 12, SPEED_MIN: 0.16 }, // raised from 0.12 - fewer badges
} as const;
...
export const P3B = {
  ...
  STORMS: {
    ...
    CONF_MIN: 0.3,       // min confidence to contribute
...
export const P4 = {
  WINDS: { MIN_ZOOM: 11, MAX_PATHS: 24, UPDATE_HZ: 2 },
  AURORA: { MIN_ZOOM: 12, INTENSITY_MIN: 0.30, MAX_CONCURRENT: 3, UPDATE_HZ: 4 },
