...
-- Venue signatures table for multi-signal venue detection
...
-- Venue boundaries table for intelligent boundary detection
...
-- Geofences: Users can manage their own geofences
...
-- Geofence data: Users can manage data for their own geofences
...
-- Proximity stats: Users can read their own stats
...
-- Trigger to automatically update proximity stats when events are inserted
