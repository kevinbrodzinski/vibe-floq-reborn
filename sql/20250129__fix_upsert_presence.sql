...
-- Drop every overload of upsert_presence
DO $$
DECLARE r RECORD;
BEGIN
  FOR r IN
...
-- Re-create with geometry storage
...
DECLARE
  ...
  v_location   GEOMETRY;               -- ← back to geometry
...
BEGIN
  ...
  v_location := ST_SetSRID(ST_MakePoint(p_lng, p_lat), 4326);  -- geometry
