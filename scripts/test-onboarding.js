...
console.log('   await supabase.from("user_onboarding_progress").delete().eq("profile_id", user.id);');
...
console.log('   console.log("Onboarding:", await supabase.from("user_onboarding_progress").select("*").eq("profile_id", user.id));');
console.log('');
