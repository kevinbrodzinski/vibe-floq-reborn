		...
		extend: {
			...
			colors: {
				...
				bg: {
					...
					outline2: 'rgba(255,255,255,0.18)',
				},
				glass: {
			...
			boxShadow: {
				glass: '0 10px 30px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.06)',
				neon: '0 0 16px rgba(64,224,255,0.35), 0 0 40px rgba(64,224,255,0.20)',
				// Design Kit tokens
			...
			dropShadow: {
				neon: '0 0 10px rgba(64,224,255,0.65)',
				violet: '0 0 12px rgba(123,132,255,0.60)',
			},
			...
			keyframes: {
				...
				"aurora-2": {
					...
					"66%": { transform: "translate(25px, -25px) scale(0.95)", opacity: "0.22" },
				},
				"aurora-3": {
					"0%, 100%": { transform: "translate(0, 0) scale(1)", opacity: "0.25" },
					"33%": { transform: "translate(20px, 40px) scale(0.9)", opacity: "0.3" },
					"66%": { transform: "translate(-30px, -20px) scale(1.1)", opacity: "0.27" },
				},
			},
